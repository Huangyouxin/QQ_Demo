...
@property (nonatomic,strong) UIView *viewCV;
    ...
    if(self = [super init]){
        ...
        for (UIView *obj in self.leftVC.view.subviews) {
            ...
            if ([obj isKindOfClass:[UIScrollView class]]) {
                self.viewCV = (UIView *)obj;
            }
        }
        self.leftTableview.backgroundColor = [UIColor clearColor];
        self.leftTableview.frame = CGRectMake(0, 100, kScreenWidth - kMainPageDistance, kScreenHeight-100);
        ...
        self.viewCV.center = CGPointMake(kScreenWidth +kLeftCenterX, kScreenHeight * 0.5);
...
- (void)closeRightView
{
    ...
    self.mainVC.view.center = CGPointMake(kScreenWidth / 2, kScreenHeight / 2);
    self.closed = YES;
    self.viewCV.backgroundColor = [UIColor redColor];
    self.viewCV.center = CGPointMake(kScreenWidth - kLeftCenterX+ 20, kScreenHeight * 0.5);
    self.viewCV.transform = CGAffineTransformScale(CGAffineTransformIdentity,kLeftScale,kLeftScale);
    self.contentView.alpha = kLeftAlpha;
...
- (void)openLeftView;
{
    ...
    NSLog(@"%0.f,%0.f,%0.f,%0.f",self.leftTableview.center.x,self.leftTableview.center.y,self.leftTableview.size.width,self.leftTableview.size.height);
    [UIView commitAnimations];
